...
export function HeroBrandEyebrow() {
  return (
    <div className="mb-2 flex flex-col gap-1 max-sm:mb-1.5 sm:mb-5 sm:flex-row sm:flex-wrap sm:items-baseline sm:gap-x-3 sm:gap-y-1">
      <Link
        href="/ueber-uns"
        aria-label={`${site.name} – Über uns`}
        className="text-[12px] font-bold leading-snug tracking-tight text-white transition-opacity hover:opacity-85 sm:text-[13px]"
      >
        Green Guard <span className="text-[#a8e055]">GmbH</span>
      </Link>
      <p className="text-[10px] font-medium leading-snug text-zinc-400 sm:border-l sm:border-white/12 sm:pl-3 sm:text-[11px]">
